...
const features = [
    ...
    {
        name: 'Electron.',
        description: 'Electron is a framework for building desktop applications with web technologies.',
        icon: CursorArrowRippleIcon
    },
    {
        name: 'Milvus.',
        description: 'Milvus is an open-source vector database powered by Faiss, an open-source library for efficient similarity search and clustering of dense vectors.',
        icon: CloudIcon
    },
    {
        name: 'Docker.',
    ...
    <Template title="AutoAttend" names={['', 'AutoAttend']}>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-5xl sm:text-center">
                ...
                connected together to create an application that can be used to track attendance in a classroom setting.
                </p>
            </div>
        </div>
