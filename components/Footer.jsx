const navigation = [
    ...
    {
        name: 'LinkedIn',
        href: 'https://linkedin.com/in/miro-manestar',
        icon: (props) => (
        ...
        <footer className="bg-background border-t-2 border-gray-600">
            <div className="mx-auto max-w-7xl py-12 px-6 md:flex md:items-center md:justify-between lg:px-8">
                ...
                <div className="mt-8 md:order-1 md:mt-0">
                    <p className="text-xs text-center md:text-left leading-5 text-gray-500">
                        &copy; 2023 Miro Manestar, Inc. All rights reserved.
                        <br />
