const Eula = () => {
    return (
        <div className="mx-auto max-w-screen-xl my-8 mt-[10vh] text-white block [&>p]:mb-2">
            <h1 className="mb-3 text-4xl font-medium">End-User License Agreement (&quot;Agreement&quot;)</h1>
            <p>Last updated: February 8, 2023</p>
            <p>Please read this End-User License Agreement carefully before clicking the &quot;I Agree&quot; button, downloading or using SAU Missions Dashboard.</p>
            <h1 className="mb-3 text-4xl font-medium">Interpretation and Definitions</h1>
            <h2 className="mb-3 text-3xl font-medium">Interpretation</h2>
            <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
            <h2 className="mb-3 text-3xl font-medium">Definitions</h2>
            <p>For the purposes of this End-User License Agreement:</p>
            <ul className="list-disc ml-9 [&>li]:mb-2">
                <li>
                ...
                <li>
                    <p><strong>Application</strong> means the software program provided by the Company downloaded by You to a Device, named SAU Missions Dashboard</p>
                </li>
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SAU Missions Dashboard.</p>
                </li>
                <li>
            ...
            <h1 className="mb-3 text-4xl font-medium">Acknowledgment</h1>
            ...
            <h1 className="mb-3 text-4xl font-medium">License</h1>
            <h2 className="mb-3 text-3xl font-medium">Scope of License</h2>
            ...
            <h1 className="mb-3 text-4xl font-medium">Third-Party Services</h1>
            ...
            <h1 className="mb-3 text-4xl font-medium">Term and Termination</h1>
            ...
            <h1 className="mb-3 text-4xl font-medium">Indemnification</h1>
            ...
            <h1 className="mb-3 text-4xl font-medium">No Warranties</h1>
            ...
            <h1 className="mb-3 text-4xl font-medium">Limitation of Liability</h1>
            ...
            <h1 className="mb-3 text-4xl font-medium">Severability and Waiver</h1>
            <h2 className="mb-3 text-3xl font-medium">Severability</h2>
            ...
            <h2 className="mb-3 text-3xl font-medium">Waiver</h2>
            ...
            <h1 className="mb-3 text-4xl font-medium">Product Claims</h1>
            <p>The Company does not make any warranties concerning the Application.</p>
            <h1 className="mb-3 text-4xl font-medium">United States Legal Compliance</h1>
            <p>You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a &quot;terrorist supporting&quot; country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.</p>
            <h1 className="mb-3 text-4xl font-medium">Changes to this Agreement</h1>
            ...
            <h1 className="mb-3 text-4xl font-medium">Governing Law</h1>
            ...
            <h1 className="mb-3 text-4xl font-medium">Entire Agreement</h1>
            ...
            <h1 className="mb-3 text-4xl font-medium">Contact Us</h1>
            <p>If you have any questions about this Agreement, You can contact Us:</p>
            <ul className="ml-9">
                <li>By email: miroimanestar@gmail.com</li>
            </ul>
        </div>
    )
}
