...
const Eula = () => {
  return (
    <Template title="SAU Dashboard EULA" names={["", "", "EULA"]}>
      <div className="text-white [&>p]:mb-2">
        ...
        <p>
          ...
          the &quot;I Agree&quot; button, downloading or using SAU Missions
          Dashboard.
        </p>
        <h1 className="mb-3 text-4xl font-medium">
        ...
        <ul className="ml-9 list-disc [&>li]:mb-2">
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              by the Company downloaded by You to a Device, named SAU Missions
              Dashboard
            </p>
          </li>
          <li>
            <p>
              ...
              in this Agreement) refers to SAU Missions Dashboard.
            </p>
          </li>
          <li>
            <p>
