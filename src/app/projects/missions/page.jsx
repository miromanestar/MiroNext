    ...
    <div className="mx-auto max-w-7xl lg:px-8">
      <div className="mx-auto max-w-5xl">
        ...
        <p className="mt-6 text-lg leading-8 text-gray-300">
          ...
          to missions opportunities at Southern Adventist University, including
          current student missionaries, SAU&apos;s presence around the globe,
          and opportunities currently available for students here.
        </p>
      </div>
    </div>
