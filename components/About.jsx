...
const About = () => (
  <section className="relative bg-background">
    <div
      className="z-10 absolute h-[15%] w-full bottom-0 bg-gradient-to-b from-transparent to-secondaryBg"
      aria-hidden="true"
    />

    <div className="gap-8 items-center py-8 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:pb-16">
      ...
      <div className="relative z-20 grid grid-cols-2 gap-4 mt-8 px-4 lg:px-0 lg:pr-8">
        <Fade triggerOnce={true} direction="right" cascade={true}>
          ...
          <img
            className="mt-4 w-full lg:mt-10 rounded-lg object-cover object-right shadow-lg h-[80%]"
