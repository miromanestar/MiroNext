...
const Cards = () => {
    return (
        <div className="relative">
            <div className="flex flex-col justify-center items-center gap-8 relative -mt-[50%] md:-mt-[20%] z-10 bg-transparent px-6 pt-16 pb-10 lg:px-8 lg:pt-24">
                <div className="relative mx-auto max-w-7xl">
                    <h2 className="text-center text-3xl font-bold tracking-tight text-white sm:text-4xl w-fit mx-auto p-3 rounded-lg drop-shadow-md">My Projects</h2>
