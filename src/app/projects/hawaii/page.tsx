...
import PCA3D from "@/components/PCA3D.jsx";
...
const HawaiiPRB = () => (
  ...
  >
    ...
    <div className="mx-auto max-w-7xl lg:px-8">
      <div className="mx-auto">
        ...
        <p className="mt-4 text-lg leading-8 text-gray-300">
          ...
          learning techniques, specifically PCA and K-Means, to analyze large
          geochemical data sets from two distinct geological regions, Hawaii and
          the Peninsular Ranges Batholith (PRB) in Southern California. The IBM
          Foundational Methodology for Data Science was utilized to ensure
          proper data preparation and analysis. PCA provided dimensionality
          reduction, revealing which features correlated most strongly with
          variances within the data. K-Means clustering allowed for deeper
          interpretation of the data. The analysis yielded valuable insights
          into the composition and differentiation of magma and rocks from the
          two regions. Future work should include a deeper analysis of the
          clusters and a determination of how geochemical plots relate to
    ...
    <p className="mt-8 mb-4 text-gray-300 sm:text-lg">
      ...
      content. The rocks in both regions are sourced primarily from material in
      the interior of the Earth, and are composed of similar elements and
      isotopes, making them good candidates for comparison.
    </p>
    ...
    <p className="mt-8 mb-4 text-gray-300 sm:text-lg">
      ...
      subduction, where one tectonic plate moved under another. In contrast,
      Hawaii was formed by a &quot;hot spot&quot; plume in the mantle that
      produced magma which subsequently erupted through the Pacific plate
      oceanic crust. The PRB is made up of granitic types of rocks which have
      gone through several stages of melting and crystallization whereas the
      Hawaiian volcanoes are composed of volcanic rocks which have mostly gone
      through only one stage of melting and crystallization. Additionally, the
      PRB includes a significant amount of material from the crust, while
      Hawaiian volcanic rock comes mostly from material further down in the
      mantle. The higher silica PRB granitic rocks extend from the Riverside
      area of California down the length of the Baja Peninsula in Mexico, though
      this analysis only concerns the northern PRB. The lower silica Hawaiian
      volcanoes occur over the length of the island chain, although much of the
    ...
    <p className="mt-8 mb-4 text-gray-300 sm:text-lg">
      ...
      Imputation was not used at any point during this anaylsis as it tends to
      destroy useful variations which are critical for unsupervised machine
      learning methods. After data cleanup and preparation, there were 10,476
      samples from Hawaii and 532 samples from the PRB. Three dimensions were
      chosen because it was found that over 84% of the variance for Hawaii and
      88% for the PRB was contained within them. Finally, three clusters were
      chosen because it was found to be the optimal number of clusters through
    ...
    <p className="mt-8 mb-4 text-gray-300 sm:text-lg">
      ...
      that the averages were not skewed by the normalization process. However,
      the clusters were generated using k-means on the normalized data which
    ...
    <p className="mt-8 mb-4 text-gray-300 sm:text-lg">
      ...
      cluster three to dacite. In the PRB, cluster one relates to gabbro,
      cluster two to tonalite, and cluster three to to granite. This was done
    ...
    <p className="mb-4 text-gray-300 sm:text-lg">
      ...
      the first dimension of the PCA plots correlated with the extent of mafic
      to felsic differentiation. The second dimension appears to distinguish
      tholeiitic from calc-alkaline differentiation. Finally, dimension three
      may be related to the number of stages or cycles through which the
    ...
    <p className="mb-4 text-gray-300 sm:text-lg">
      ...
      account the above PCA figures and feature average tables, the following
    ...
    <ul className="mb-4 ml-8 list-disc text-gray-300 sm:text-lg">
      <li>
        ...
        with basalt having negative values, and the dacite having positive
        values. Dimension two values appear to display tholeiitic and
        calc-alkaline differentiation trends, with the basalt displaying
        tholeiitic fractionation from Mg to Fe in olivine, and the dacite
        displaying calc-alkaline fractionation from Ca to Na to K in feldspar.
        Ti was found to be important in this dimension. Dimension three values
        may indicate alkalinity and &quot;feldspathoids&quot;, with both the
        alkaline basalt and dacite having negative values.
      </li>
      <li>
        In the PRB, the plutonic sequence ranges from gabbro to tonalite to
        granite. Dimension one values indicate the degree of differentiation,
        with gabbro having negative values and granite having positive values.
        Dimension two values seem to distinguish the western PRB with
        &quot;tholeiitic basement&quot; from the eastern PRB with
        &quot;calc-alkaline basement&quot;, with the western PRB having low
        values for Fe, Al, Na, and K, and the eastern PRB having high values. Fe
        was observed as going from low to high to low again, and thus found to
        be important in this dimension. Dimension three values may distinguish
        the number of melt/crystallization cycles, with the western PRB having
        perhaps two cycles, and the eastern PRB having more cycles. Na was found
        to be important in this dimension.
      </li>
    </ul>
    ...
    <p className="mb-4 text-gray-300 sm:text-lg">
      ...
      transformation of the data will be used to study the closure problem.
      Moreover, determining how geochemical plots relate to the underlying
      magmatic processes, which formed these regions and their rates, is an
...
const differences = {
  ...
  data: [
    [
      ...
      "Mostly calc-alkaline differentiation\n(Mg, Fe, Ca -> Na, K)",
    ],
    [
      "Basaltic (higher in e.g.. Mg, Fe, Ti, Ca, Crr)",
      "Granitic (higher in e.g. K, Rb, Cs, Zr, U)",
    ],
    [
      "Plume (mantle hotstop produced magma which erupted through the Pacific plate)",
      "Subduction (one tectonic plate moved under another generating intrusive and extrusive magma)",
    ],
  ],
};
...
const tech = [
  ...
  },
  {
    ...
    type: "Software",
    content:
      "Jupyter is an open-source web-based interactive development environment (IDE) that allows users to create and share documents that contain live code, equations, visualizations, and narrative text. Jupyter supports multiple programming languages including Python, R, Julia, and others.",
